...
public class Report {
    ...
    public String getReporterLastLocation(){
        return reporterPlayer.getLastLocation();
    }

    public String getReportedLastLocation(){
        return reportedPlayer.getLastLocation();
    }

    public String getReporterLastServer(){
        return reporterPlayer.getLastserver();
    }

    public String getReportedLastServer(){
        return reportedPlayer.getLastserver();
    }

    public String getReporterLastConnection(){
        return reporterPlayer.getLastConnection();
    }

    public String getReportedLastConnection(){
        return reportedPlayer.getLastConnection();
    }

    public boolean getReporterIsOnline(){
        return reporterPlayer.isOnline();
    }

    public boolean getReportedIsOnline(){
        return reportedPlayer.isOnline();
    }
}
