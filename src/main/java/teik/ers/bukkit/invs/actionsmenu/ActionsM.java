package teik.ers.bukkit.invs.actionsmenu;
...
import teik.ers.bukkit.configs.inventories.ActionsMenu;
...
public class ActionsM {
    ...
    public void createActionsMenu(InventoryPlayer inventoryPlayer){
        ...
        invsUtils.fillWithGrayGlassPanes(inventory, 0, 26);
        invsUtils.fillWithDarkGlassPanes(inventory, 27, 35);
