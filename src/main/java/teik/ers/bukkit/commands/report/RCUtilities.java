...
public class RCUtilities {
    ...
    public RCUtilities(ReportMG reportMG, NotifysMG notifysManager, UtilitiesPlayers utilitiesPlayers, String reportSuccessful,
                       MaxReportsMG maxReportsMG) {
        this.reportMG = reportMG;
    ...
    public void addReport(Player reporter, String[] args){
        //Date
