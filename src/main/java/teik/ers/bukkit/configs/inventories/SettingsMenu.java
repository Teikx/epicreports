package teik.ers.bukkit.configs.inventories;
...
public class SettingsMenu {
    ...
    private String menuTitle, enabledText, disabledText, sizeTitle, textTitle, maxReportsTitle, skipNotifyReportsTitle,
            customizeCommandTitle, menuAliasTitle, reportOfflinePlayersTitle, discordMenuTitle, notifysMenuTitle;
    private List<String> sizeLore, textLore, maxReportsLore, skipNotifyReportsLore, customizeCommandLore, menuAliasLore,
            reportOfflinePlayersLore, discordMenuLore, notifysMenuLore;

    public SettingsMenu(EpicReports plugin) {
        inventoryFile = new CustomConfig("settings-menu.yml", "inventories", plugin, false);
    ...
    private void loadInventory() {
        ...
        this.enabledText = convertColor(inventory.getString("Enabled"));
        this.disabledText = convertColor(inventory.getString("Disabled"));
