...
public class MessagesFile {
    ...
    private String prefix, report_successful, command_use, player_not_exist, max_reports_to_player, report_yourself,
            console_report, disabled_plugin, player_not_found, server_not_found, teleported;
    ...
    private void loadMessages() {
        ...
        this.command_use = prefix + messages.getString("User_msgs.command_use");
