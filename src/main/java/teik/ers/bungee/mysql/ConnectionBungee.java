...
public class ConnectionBungee {
    ...
    private void logError() {
        plugin.getLogger().info(ChatColor.translateAlternateColorCodes('&',"&b[&fEpicReports&b] &cError connecting to your DataBase, the plugin is disabled"));
    }
    private void logInfo() {
        plugin.getLogger().info(ChatColor.translateAlternateColorCodes('&',"&b[&fEpicReports&b] &aEpicReports connected to MYSQL"));
    }
